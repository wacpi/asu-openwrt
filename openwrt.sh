...
var config = {
  ...
  asu_extra_packages: ["luci-i18n-attendedsysupgrade-zh-cn", "luci-i18n-base-zh-cn", "luci-i18n-firewall-zh-cn", "luci-i18n-package-manager-zh-cn", "block-mount", "bridger", "kmod-nf-nathelper"],
  asu_repositories: {
